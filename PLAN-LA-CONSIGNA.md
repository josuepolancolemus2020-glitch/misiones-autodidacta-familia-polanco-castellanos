...
- `personaje` · Protagonista · ○ — Quién vive la historia, qué quiere y qué se lo impide: sin un deseo y algo que lo estorbe no hay cuento, hay una lección con dibujos. Di también cómo es por fuera, para que salga igual en todas las páginas. — Ej.: «Gotita, una gota de agua redonda y transparente, con las mejillas rosadas. Quiere quedarse para siempre en su nube, porque le da miedo caer; pero cada vez pesa más.» — Frases: «Se llama {{protagonista}} y quiere {{deseo}}, pero {{obstaculo}}.» · «Quiere {{deseo}}, pero lo que de verdad necesita es {{necesidad}}.» · «Tiene un defecto que lo hace querible: {{defecto}}.» · «Por fuera es {{aspecto}}, y así sale en todas las páginas.» · «Lo acompaña {{amigo}}, que lo ayuda pero no le resuelve nada.» · «Que se parezca a la foto o al dibujo que voy a subir.»
...
- El repaso, en este molde (§5, paso 3; todos AVISAN, ninguno para: guardar y usar se siguen pudiendo): «Protagonista» vacío, porque la máquina lo inventa y lo inventa distinto en cada página; «Para quién» sin ninguna edad (ni una cifra ni una palabra de edad: niños, adolescentes, adultos, primaria…), porque la edad manda en todo lo demás; un «Tema de la historia» que dice que el cuento explica o enseña algo con «Lo que el cuento explica» vacío, porque sin los datos exactos la máquina los inventa o los simplifica hasta que dejan de ser verdad; «Lo que el cuento explica» de más de 120 palabras, que es mucho para un cuento breve; y, solo con Storybook, una «Extensión» que pide más de doce páginas, que Storybook no hace.
...
**Storybook es la máquina de UN molde.** El Cuento que enseña la trae declarada (`maquina: 'storybook'`): una pieza nueva de ese molde nace con ella, cambiar a ese molde la pone, y salir de él con Storybook puesto devuelve la última de este aparato. Y Storybook **no se apunta como la última**: si se apuntara, el Rápido siguiente nacería para Storybook, que no hace otra cosa que libros. Sale en todas las filas de máquinas como una más, porque un Libre pegado de otro sitio también se le puede llevar; y «Duplicar en otro molde» no se la lleva a un molde que no es el suyo.
...
**Cuento que enseña en `seguida` (Storybook)** (la cabecera del molde delante; cada bloque en su párrafo, las Reglas como frases seguidas; con Claude, el mismo cuento sale en `xml`, y con ChatGPT o Gemini, en `md`):
```
