...
/* ---------- preguntas de las tres lecturas ----------
   Pedido del autor: la sección de Lecturas no se queda en leer. Lleva
   quince preguntas de comprensión lectora (cinco por texto, y todas se
   contestan con el texto delante, no de memoria), diez de completar y diez
   de análisis complejo con su pauta. Las tres baterías se imprimen, y las
   tres lecturas también, cada una por separado.                        */
B.lectComprensionBank = JSON.stringify([
  /* --- el cuento a la manera de Borges --- */
  { t: 'Borges', q: '¿Con qué fórmula descartaba a los demás el hombre del cuento?', o: ['a) «Yo no tengo ideología; yo tengo sentido común»', 'b) «Todo es relativo, así que nada importa»', 'c) «Solo creo lo que puedo tocar»', 'd) «La política no me interesa»'], c: 0 },
  { t: 'Borges', q: 'Según el narrador, ¿para qué inventó Destutt de Tracy la palabra?', o: ['a) Para insultar a los intelectuales de su tiempo', 'b) Para nombrar una ciencia sobre cómo se forman las ideas en cualquier cabeza', 'c) Para titular un manifiesto político', 'd) Para describir una enfermedad del entendimiento'], c: 1 },
  { t: 'Borges', q: 'El narrador dice que la palabra nació como…', o: ['a) Un arma', 'b) Una bandera', 'c) Un espejo, y no como un dedo', 'd) Un dedo, y no como un espejo'], c: 2 },
  { t: 'Borges', q: '¿Qué moraleja saca el narrador de la fábula del mapa del tamaño del imperio?', o: ['a) Que los imperios siempre caen', 'b) Que los mapas grandes son más exactos', 'c) Que la cartografía es una ciencia inútil', 'd) Que un mapa sirve porque elige, y elegir es dejar cosas afuera'], c: 3 },
  { t: 'Borges', q: '¿Por qué defendía su mapa con tanta fuerza el hombre del cuento?', o: ['a) Porque no lo había visto nunca', 'b) Porque lo había estudiado a fondo', 'c) Porque se lo había enseñado un maestro', 'd) Porque lo había escrito él mismo'], c: 0 },
  /* --- el capítulo a la manera de Cervantes --- */
  { t: 'Cervantes', q: '¿Con qué razón sostenía el arriero que la pieza era una bacía?', o: ['a) Porque la había visto en un libro', 'b) Porque su padre había sido barbero en Almodóvar', 'c) Porque el ventero se lo había dicho', 'd) Porque la había comprado él mismo'], c: 1 },
  { t: 'Cervantes', q: 'Cuando los dos bandos se calentaron, ¿de qué pasaron a disputar?', o: ['a) Del precio de la cena', 'b) De quién había llegado primero a la venta', 'c) De quién tenía los ojos limpios', 'd) Del dueño legítimo de la pieza'], c: 2 },
  { t: 'Cervantes', q: '¿Para qué mandó traer don Quijote los antojos del ventero?', o: ['a) Para leer una carta en voz alta', 'b) Para regalarlos al arriero', 'c) Para venderlos a tres reales', 'd) Para mostrar que no muda la pieza, sino el que mira'], c: 3 },
  { t: 'Cervantes', q: 'Según la sentencia de don Quijote, ¿dónde está el agravio?', o: ['a) No en llevar antojos, que es forzoso, sino en jurar que no se llevan', 'b) En llevar antojos, porque el sabio mira desnudo', 'c) En no querer comprar antojos nuevos', 'd) En disputar con un arriero, que es de baja condición'], c: 0 },
  { t: 'Cervantes', q: '¿Por qué el nombre «baciyelmo» acabó sirviendo a todos?', o: ['a) Porque lo propuso el ventero, que era el dueño', 'b) Porque a nadie contentó del todo', 'c) Porque venía en los libros de caballerías', 'd) Porque era el más corto de los tres nombres'], c: 1 },
  /* --- el ensayo a la manera de Harari --- */
  { t: 'Harari', q: '¿Qué diferencia pone el ensayo entre un chimpancé y un humano ante una frontera?', o: ['a) El humano la respeta y el chimpancé la cruza', 'b) Los dos ven una línea, pero el humano la mide', 'c) El chimpancé ve pasto; el humano ve una patria', 'd) El chimpancé ve peligro; el humano ve comercio'], c: 2 },
  { t: 'Harari', q: '¿Cuánto tiempo estuvo «La ideología alemana» sin publicarse completa?', o: ['a) Diez años', 'b) Treinta años', 'c) Cincuenta años', 'd) Ochenta y seis años, de 1846 a 1932'], c: 3 },
  { t: 'Harari', q: 'Según el ensayo, ¿por qué es peligrosa la idea de falsa conciencia?', o: ['a) Porque una teoría que explica cualquier respuesta no prohíbe ninguna', 'b) Porque nadie la entiende bien', 'c) Porque es demasiado antigua para servir', 'd) Porque la escribió Engels y no Marx'], c: 0 },
  { t: 'Harari', q: '¿Qué hizo Mannheim en 1929 que, dice el ensayo, casi nadie hace?', o: ['a) Publicar en dos idiomas a la vez', 'b) Apuntar el instrumento hacia sí mismo', 'c) Renunciar a su cátedra por una idea', 'd) Refutar a Marx con datos'], c: 1 },
  { t: 'Harari', q: '¿Con qué compara el ensayo la promesa de «pensar sin ideología»?', o: ['a) Con leer sin luz', 'b) Con nadar contra la corriente', 'c) Con caminar sin apoyar los pies', 'd) Con dibujar un mapa de memoria'], c: 2 },
]);
B.lectCompletarBank = JSON.stringify([
  { t: 'las tres', q: 'La palabra «ideología» se acuñó hacia el año ___.', a: '1796' },
  { t: 'Borges', q: 'El narrador dice que la palabra nació como un ___, y no como un dedo.', a: 'espejo' },
  { t: 'Borges y Harari', q: 'La frase «falsa conciencia» está en una carta de Engels a Franz ___.', a: 'Mehring' },
  { t: 'Borges y Harari', q: 'Esa carta es del 14 de julio de ___.', a: '1893' },
  { t: 'Cervantes', q: 'El arriero sostenía que la pieza de bronce era una ___ de barbero.', a: 'bacía' },
  { t: 'Cervantes', q: 'El estudiante sostenía, en cambio, que era un ___.', a: 'yelmo' },
  { t: 'Cervantes', q: 'Don Quijote mandó traer unos ___ para probar su sentencia.', a: 'antojos' },
  { t: 'Cervantes', q: 'El nombre en que quedaron todos de acuerdo fue ___.', a: 'baciyelmo' },
  { t: 'Harari', q: '«La ideología alemana» no se publicó completa hasta ___.', a: '1932' },
  { t: 'Harari', q: 'Mannheim, que era judío, tuvo que abandonar Alemania en ___.', a: '1933' },
]);
B.lectAnalisisBank = JSON.stringify([
  { q: '1. Las tres lecturas cuentan el mismo expediente. Explica qué hace cada voz que las otras dos no pueden hacer, y qué se perdería si se leyera solo una.', guia: 'El cuento instala la idea como imagen que no se olvida: el hombre que llevaba su mapa doblado en el bolsillo y lo defendía porque no lo había visto nunca. El capítulo la vuelve escena y risa, y por eso se recuerda con el cuerpo: la misma pieza de bronce vista como bacía o como yelmo, y Sancho vendiendo antojos de vidrio mientras su amo habla de los del entendimiento. El ensayo la pone a escala de especie y con fechas comprobables, y por eso se puede citar. Quien lee solo una se queda sin una de las tres cosas: la imagen, la escena o la prueba, y las tres hacen falta, porque el concepto tiene que sobrevivir a la memoria, a la conversación y al examen.' },
  { q: '2. El hombre del cuento y los dos bandos de la venta cometen el mismo error con nombres distintos. Nómbralo en una frase y di qué prueba usaría cada autor para demostrárselo.', guia: 'El error es el mismo: creer que se mira sin nada delante de los ojos, y por tanto llamar verdad al mapa propio y antojos al del vecino. La prueba de Borges es histórica: enseñarle que la palabra con que descarta a los otros nació en 1796 para estudiar todas las cabezas, incluida la suya. La prueba de Cervantes es física y mucho más rápida: pone los antojos sobre la mesa, todos ven la pieza igual, y con eso queda claro que lo que cambia es el que mira y no la pieza. La de Harari es estadística y de escala: si millones de personas ven patria donde un chimpancé ve pasto, el mapa está en la cabeza, y quien afirma no tenerlo tendría que explicar por qué es la única excepción de la especie.' },
  { q: '3. Traduce la sentencia de don Quijote («el agravio no está en llevarlos, sino en jurar que no se llevan») al vocabulario de Mannheim, y explica por qué relacionismo no es relativismo.', guia: 'La traducción: llevar antojos es la condición de mirar, así que no es un defecto que se pueda corregir; lo que sí es un defecto es negarlo, porque quien niega su posición se pone fuera del examen y deja de poder ser corregido. Eso es exactamente lo que Mannheim aceptó en 1929: si toda posición social produce su punto de vista, el que desenmascara también mira desde algún lado, y por eso hay que declarar el lugar propio. No es relativismo porque declarar el lugar no iguala los mapas: dos mapas parciales del mismo terreno siguen siendo comparables, y uno llega al río. El relativismo abandona el juicio; el relacionismo lo conserva y le exige domicilio.' },
  { q: '4. El ensayo llama a la falsa conciencia «un arma cómoda y un instrumento inútil». Explica las dos mitades por separado y aplica la crítica a un caso de esta casa.', guia: 'Arma cómoda: permite ganar cualquier discusión sin escuchar, porque el desacuerdo del otro se reclasifica como síntoma y no como razón; y encima se siente como lucidez, que es lo que la hace tan barata. Instrumento inútil: una explicación que da cuenta de cualquier respuesta posible (si asiente, tiene conciencia clara; si objeta, tiene conciencia falsa) no prohíbe ninguna, y lo que no prohíbe nada no informa de nada. El caso de la casa es el de Jael despachando al tío: la frase cerró la conversación, que era lo único que había que conservar. La corrección tiene dos partes, la de fuente (es de Engels, en su carta a Mehring del 14 de julio de 1893, no de la obra publicada de Marx) y la de método: quien diagnostica paga el diagnóstico esa misma noche con una creencia propia que le convenga creer.' },
  { q: '5. ¿Por qué el dato de que «La ideología alemana» durmió ochenta y seis años cambia la manera de citarla? Escribe una cita mal fechada y su corrección.', guia: 'Porque una obra publicada en 1932 no pudo influir en los debates de 1848, 1871 ni 1900, y media discusión del siglo veinte se hizo con un libro que los protagonistas del siglo diecinueve nunca leyeron. Citarla como si hubiera circulado desde 1846 inventa una cadena de influencia que no existió. Cita mal fechada: «desde 1846, la tesis de la cámara oscura organizó el debate europeo sobre las ideas». Corrección: «la tesis de la cámara oscura fue escrita en 1845 y 1846, pero solo pudo organizar debates a partir de 1932, cuando el manuscrito se publicó completo». La regla general que sale de aquí: la fecha de escritura explica al autor, y la fecha de publicación explica los efectos; confundirlas es fabricar historia.' },
  { q: '6. Los tres textos rechazan la misma salida cómoda. Reconstruye la mejor versión de esa salida, en su forma más fuerte, y contéstala.', guia: 'La mejor versión, que hay que poner en pie antes de tocarla como manda la regla del acero: si toda mirada viene de una posición y ninguna es neutral, entonces cualquier juicio es una posición más, incluido este; pretender arbitrar entre mapas es solo imponer el mapa propio con mejores modales, así que lo honesto es abstenerse. La respuesta tiene tres piezas. Una, la de Mannheim: la parcialidad de origen no implica igualdad de valor, y él nombró esa diferencia relacionismo justamente para que no se confundiera. Dos, la de Geertz: los mapas se comparan por lo que permiten hacer, y algunos permiten llegar al río; el criterio no desaparece, cambia de sitio. Tres, la práctica: la abstinencia no es neutral, porque quien se abstiene le deja el juicio a quien grite más fuerte, y eso también es un resultado político.' },
  { q: '7. En el cuento, el narrador dice que el error del hombre «es el mío en los días en que me distraigo». Explica por qué ese renglón hace legítimo el resto del cuento, y qué le pasa a un texto que no lo trae.', guia: 'Porque sin ese renglón el cuento sería lo que dice criticar: un texto que reparte ceguera hacia afuera desde una posición que no se examina, es decir el uso napoleónico de la palabra con mejor prosa. Con ese renglón el narrador se incluye en el diagnóstico, y entonces la observación deja de ser una insignia de superioridad y pasa a ser un instrumento que también lo mide a él. Un texto que no lo trae puede ser brillante y sigue siendo un arma: se lee con placer, no cambia a nadie que no estuviera de acuerdo, y produce lectores que aprenden a ver gafas ajenas y se creen descalzos, que es la trampa propia de esta materia. La regla de la casa es esa misma en formato de contabilidad: un desenmascaramiento propio por cada uno ajeno.' },
  { q: '8. ¿Cuál de las tres lecturas convencería mejor a alguien que dice «yo no soy ideológico, soy pragmático»? Defiende tu elección citando una frase del texto que elegiste.', guia: 'Cualquiera de las tres se acepta si la defensa es buena, y lo que se corrige es el argumento, no la elección. La defensa más frecuente y más sólida es la del capítulo cervantino, porque el pragmático no discute con teoría sino con evidencia inmediata, y la escena se la da: los antojos se ponen sobre la mesa, todos ven la pieza igual, y la frase que remata es «no es la pieza la que muda, sino el que mira». Además no lo humilla: don Quijote dice que llevar antojos es forzoso, así que el pragmático no queda como tonto sino como normal. La defensa del ensayo es buena si se apoya en el dato de escala (chimpancé y frontera) y la del cuento si se apoya en el retrato final, el hombre que murió convencido de su transparencia; lo que no se acepta es elegir sin citar, porque entonces no se leyó.' },
  { q: '9. El «baciyelmo» es un acuerdo que a nadie contentó del todo. Discute si sirve como modelo para las fichas de M.E.T.A.S o si es una trampa, y con qué condición.', guia: 'Sirve y es trampa, según qué se esté nombrando, y la respuesta buena distingue las dos cosas. Sirve cuando el pleito es de vocabulario y no de hechos: si dos lados llaman de distinto modo a lo mismo, un término que no cierre por debajo (prosa llana en vez del término de un glosario) deja la disputa a la vista en vez de resolverla a favor de uno, y eso es exactamente lo que la casa pidió en el caso del glosario de L 60,000. Es trampa cuando se usa para no decidir un asunto de hecho: si la pregunta es qué dice la Constitución de 1982 o quién paga el proyecto, inventar una palabra intermedia no es prudencia, es niebla, y la niebla siempre favorece al que ya tenía el poder. La condición: el baciyelmo vale para nombrar, nunca para describir, y en la ficha va con las dos lecturas al lado.' },
  { q: '10. Las tres lecturas llevan la etiqueta de ejercicio de estilo de la casa. Explica por qué esa etiqueta es parte del temario y no un trámite, y qué pasaría si se quitara.', guia: 'Porque la materia entera enseña a pedir fuente, fecha y estatus, y un texto que imita la voz de Borges sin declararlo sería una fuente inflada dentro de la propia clase: enseñaría la regla y la rompería en la misma página, que es la manera más rápida de perder la autoridad para exigirla. Y porque el pastiche declarado hace visible algo que la etapa quiere enseñar: la voz también es un mapa, y una idea suena más verdadera dicha con la prosa de un clásico, así que conviene saber cuándo lo que convence es el argumento y cuándo el timbre. Si se quitara, pasarían dos cosas: alguien citaría a Borges diciendo algo que Borges no escribió, y la casa quedaría produciendo exactamente el tipo de material que su compendio manda cazar. De ahí la regla extra: la voz es el único artificio permitido, y toda obra, fecha y persona de dentro es real y comprobable.' },
]);
