...
/* ---------- las cinco lecturas: comprensión (25, cinco por voz) ---------- */
...
B.lectCompletarBank = JSON.stringify([
  { t: 'las cinco', q: 'Hebb publicó «The Organization of Behavior» en el año ___.', a: '1949' },
  { t: 'las cinco', q: 'El eslogan lo formularon Löwel y Singer en la revista ___.', a: 'Science' },
...
/* ---------- análisis complejo (10, sin XP a propósito) ---------- */
B.lectAnalisisBank = JSON.stringify([
  { q: '1. Las cinco lecturas llegan al mismo asunto por cinco puertas. Explica qué hace cada voz que las otras no pueden hacer, y qué se perdería leyendo solo una.', guia: 'El cuento convierte el concepto en un objeto heredado, el metrónomo con su nota de tres palabras, y en una vergüenza personal: el narrador tardó cuarenta años en entender a un maestro al que consideró lento. El capítulo lo vuelve escena y risa: sesenta golpes que enseñan sesenta veces a torcer el hierro se recuerdan mejor que cualquier tabla, y el ventero que ha visto llover cuarenta años sin hacer llover resume el asunto en una línea. El ensayo pone la escala de especie y encadena los estudios con sus años (1947, 1949, 1958, 1986, 1992, 1997, 1998, 2000), que es lo que permite comprobar. La entrevista sienta al personaje real de la etapa, Hebb, frente a preguntas con su biografía delante, y de paso enseña quién fue Soler Serrano y qué era «A fondo». Y la conversación baja el tema al habla viva de la noche: Quintero trae los números y Gala los devuelve convertidos en imágenes (el camino de la alameda, el actor que suelta el papel). Leyendo solo una se tendría, según el caso, melancolía sin datos, risa sin método, datos sin imagen, biografía sin escena o poesía sin cifras.' },
  { q: '2. Escribe el postulado de Hebb entero y explica qué cambia, en la práctica del lunes, si se sustituye por el eslogan de 1992.', guia: 'El postulado dice que cuando el axón de A está lo bastante cerca de B para excitarla y participa de forma repetida o persistente en hacerla disparar, ocurre un cambio de crecimiento o metabólico que aumenta la eficacia de A para disparar a B. El eslogan dice que lo que dispara junto se cablea junto. La diferencia práctica es enorme y se ve en la conducta del maestro: con el eslogan basta con poner dos cosas juntas y esperar (el mapa al lado del texto, el audio de fondo, la clase encendida mientras el alumno mira), porque la simultaneidad ya sería suficiente. Con el postulado hace falta que algo que hace el alumno participe en el resultado, así que el lunes se le pide que produzca y se le dice enseguida si salió. Además el eslogan pierde el orden, y el orden decide el signo del cambio. Y hay un tercer costo, que no es científico sino de credibilidad: el eslogan se atribuye a Hebb y no es suyo, así que citarlo así enseña a citar mal.' },
  { q: '3. Don Aciar prohibía repetir y el maestro Cebrián dijo «cien veces qué». Explica en qué coinciden los dos maestros y por qué la repetición sola no basta.', guia: 'Coinciden en tratar la repetición como un multiplicador y no como un mérito. Don Aciar no dejaba repetir un pasaje sin haber nombrado antes qué iba a salir mal, y no dejaba pasar de compás si el error no se decía en voz alta en el instante; Cebrián no dejaba dar el segundo golpe sin haber mirado el primero y sin decir qué salió. Los dos están protegiendo lo mismo: que lo que se multiplique sea el acierto y no el error, porque la regla de Hebb no distingue entre los dos y refuerza con la misma diligencia lo que encuentre. De ahí que la repetición sola no baste: sin corrección, cien repeticiones producen un error firmemente cableado, que es exactamente el caso del papá que escribe con dos dedos desde hace veinte años. La corrección, además, tiene que llegar pronto: el caballo se alcanza en el primer tranco o ya es costumbre.' },
  { q: '4. ¿Por qué el ensayo dice que las pantallas ofrecen «coincidencia perfecta y causalidad cero»? Aplica la frase a un caso de tu casa.', guia: 'Porque un video, un audio o una clase grabada avanzan solos: los estímulos ocurren a la vez que la tarde, pero nada de lo que hace quien mira participa en lo que ocurre en la pantalla. Eso cumple el eslogan al pie de la letra (todo dispara junto) y no cumple ninguna de las cuatro piezas del postulado, porque falta la participación y con ella se van la dirección y el orden. El caso de la casa es el de Angelly y sus sesenta horas de video de inglés en un mes mientras ordena el cuarto: la sensación de estar aprovechando el tiempo es alta y lo cableado es cero, salvo la destreza de tener ruido en inglés de fondo. La corrección del caso no es dejar la pantalla, sino cambiar veinte minutos de recepción por veinte minutos de producción con comprobación inmediata: repetir en voz alta, contestar, escribir y ver enseguida si salió.' },
  { q: '5. Hebb insiste en la entrevista en que llamó «postulado» a su enunciado y en que la idea general no era suya. ¿Por qué esas dos precisiones importan para la regla del estatus del Estudio Mayor?', guia: 'Porque las dos son declaraciones de estatus hechas por el propio autor, y la regla de la casa dice que ningún estudio entra sin su etiqueta. Llamarlo postulado significa: esto es una conjetura teórica, no un resultado experimental, y alguien tendrá que comprobarlo. Quien lo cita como ley demostrada de 1949 está inflando la fuente, aunque lo haga con admiración. Decir que la idea general venía de antes (Tanzi y Ramón y Cajal habían conjeturado en el siglo XIX que el uso fortalece las conexiones) evita el otro inflado, el del genio solitario, y sitúa su aportación en lo concreto: la condición de participación, la asamblea de células y la secuencia de fases. Y hay una consecuencia práctica: como era conjetura, lo que la sostiene hoy son las mediciones de 1997 y 1998, que a su vez tienen su propia letra chica.' },
  { q: '6. Compara lo que dice Gala sobre el actor que suelta el papel con lo que dice Hebb sobre las ratas de 1947. ¿Cuál es la idea común?', guia: 'La idea común es que la diferencia no está en el estímulo sino en quién produce. El actor que ensaya con el papel en la mano tiene delante exactamente el mismo texto que tendrá la noche del estreno, y sin embargo no está aprendiendo el papel: está acompañando al texto, que corre solo. La función, dice Gala, empieza la noche en que suelta el papel y se equivoca delante de alguien. Las ratas de la jaula tenían delante exactamente el mismo laboratorio que las que Hebb se llevó a casa; lo que no tenían era la posibilidad de tropezar con él. Hebb lo dice con las mismas palabras: la diferencia no fue el estímulo, fue quién producía el movimiento. Las dos escenas ilustran la palabra «participa» del postulado, y las dos explican por qué mirar cablea mirar.' },
  { q: '7. Toma una práctica real de esta semana y desármala con la hoja de la práctica (qué se produce, qué solo se recibe, quién corrige y cuándo, en qué orden). Termina diciendo qué UNA cosa cambiarías.', guia: 'Se valora que la práctica sea real y concreta, no un ejemplo de manual, y que las cuatro casillas estén contestadas con hechos y no con intenciones. Producción: qué sale de las manos o de la boca de quien practica, contado en veces y no en minutos. Recepción: qué avanza solo delante de él. Corrección: quién la da, en qué forma y con cuánto retraso desde el intento; vale una persona, una respuesta tapada, una grabación o el resultado visible de la acción. Orden: si el intento va antes de la comprobación o si el modelo se vio primero. Y el cambio propuesto debe ser uno solo y barato, casi siempre el mismo: convertir un rato de recepción en un rato de producción con comprobación inmediata. Se penaliza proponer cinco cambios a la vez, porque así no se sabe cuál funcionó.' },
  { q: '8. El ensayo cita a Ericsson (1993) y a Macnamara y colegas (2014) uno detrás del otro. Explica por qué la casa no cita al primero sin el segundo.', guia: 'Porque Ericsson describió la práctica deliberada (trabajar al borde de la propia capacidad con retroalimentación inmediata) y esa descripción es sólida y sigue siendo el mejor método de entrenamiento conocido, pero el tamaño de su efecto se infló muchísimo por el camino. Macnamara, Hambrick y Oswald revisaron el conjunto de la evidencia en 2014 y encontraron que la práctica explica alrededor del doce por ciento de la variación entre personas, menos en educación y en profesiones. Citar solo a Ericsson deja la promesa de que cualquiera llega a cualquier sitio con horas suficientes, que es la versión de las diez mil horas que popularizó un libro de divulgación de 2008 y que el propio Ericsson desmintió. Citar solo a Macnamara deja la conclusión contraria y también falsa, que practicar da igual. La regla de la casa es que ninguna afirmación entra al mapa sin su mejor crítica en la casilla de al lado.' },
  { q: '9. «Se gana lo practicado y nada más.» Explica la cláusula de especificidad con dos ejemplos de las lecturas y uno de tu vida.', guia: 'La cláusula dice que el cambio producido por la práctica es específico de lo que se practicó, y de ahí que no exista el entrenamiento genérico del cerebro. En las lecturas hay dos ejemplos claros: los taxistas de Londres de Maguire (2000), que tenían más grande la parte del hipocampo que maneja mapas y no un cerebro mejor en todo, y el aprendiz que mira quince años y se vuelve excelente reconociendo, que es exactamente lo que practicó. El de la propia vida debe cumplir la misma forma: una destreza que se ganó y otra parecida que no vino de regalo (saber cantar la tabla y no saber el par suelto, entender el inglés escrito y no poder hablarlo, reconocer una buena fotografía y no saber tomarla). Se valora que el ejemplo distinga bien qué se practicó de qué se esperaba recibir gratis.' },
  { q: '10. Escribe la carta de dos párrafos con que la familia rechaza la aplicación de L 250 al mes, sin insultar a nadie y con las fuentes correctas.', guia: 'El primer párrafo va a la cita: la frase de su publicidad no es de Hebb. La formulación es de Löwel y Singer, en Science, en 1992, y la versión rimada la puso en circulación Carla Shatz ese mismo año; lo que Hebb escribió en 1949, en el capítulo 4 de «The Organization of Behavior», es un postulado más exigente que además él declaró conjetura. Se dice sin agresión y con la referencia completa, porque el dato es comprobable y ese es todo el argumento. El segundo párrafo va a la promesa: el cambio es específico de lo practicado, así que un juego mejora el juego, y por eso el dinero se destina a practicar la tarea real que se quiere mejorar. Se cierra con la condición con que sí se aceptaría, que es la costumbre de esta casa: casi ninguna oferta se rechaza entera, se rechaza con condiciones dichas en frío.' },
]);
